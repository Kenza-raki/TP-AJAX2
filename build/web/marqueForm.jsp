                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=m.getLibelle()%></td>
                                   ...
                                   <td><a class="bndelete" href="MarqueController?op=delete&id=<%=m.getId()%>" onclick="showConfirmation(<%=m.getId()%>)">Supprimer</a></td>
                           
                          
                            <td><a class="bndelete" onclick="showConfirmation2(<%=m.getId()%>)" href="MarqueController?op=update&id=<%=m.getId()%>" >Modifier</a></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
